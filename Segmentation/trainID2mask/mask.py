...
TRAINID_PATH = "../trainID_with_shadow"
MASK_PATH = "../mask_with_shadow"
# TRAINID_PATH = "/media/andy/Data/Data/APA_SSE/APA_xinboyou/收回成品/a/trianID"
# MASK_PATH = "/media/andy/Data/Data/APA_SSE/APA_xinboyou/收回成品/a/mask"
...
cityscapes_data_path = os.path.join(TRAINID_PATH, "*.png")
...
for img in imgList:
    ...
    label_img=label_img_to_color(label_img) # generate color_map
    # i += 1
